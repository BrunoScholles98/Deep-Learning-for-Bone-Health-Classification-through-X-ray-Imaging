...
OUTPUT_PATH = Path('/d01/scholles/gigasistemica/saved_models/Full_Img/' + TRAIN_NAME)
...
def main():   
    ...
    model = create_model('fastvit_t8.apple_in1k', pretrained=True)
    #checkpoint = torch.load('/d01/scholles/gigasistemica/pre_trained_models/fastvit_t8_reparam.pth.tar')
